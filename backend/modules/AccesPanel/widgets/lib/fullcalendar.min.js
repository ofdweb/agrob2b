...
(function(t) {
        ...
        function Re(n, i) {
                ...
                var W, Z, j, U, $, X, K, Q, J = N.isFetchNeeded,
                    te = N.fetchEvents,
                    ee = n[0],
                    ne = {},
                    ie = 0,
        ...
        }), Ae = "_d" in e() && "updateOffset" in e, Oe = Ae ?
        function(t, n) {
        ...
        var Ke = ue.extend({
            ...
            rn = ue.extend({
                        ...
                        getHtmlRenderer: function(t, e) {
                                ...
                                return n = t + "Html", e && (i = e + Z(t) + "Html"), i && (s = o[i]) ? r = o : i && (s = this[i]) ? r = this : (s = o[n]) ? r = o : (s = this[n]) && (r = this), "function" == typeof s ?
                                function() {
        ...
        var an = Le.View = ue.extend({
                ...
                unselect: function(t) {
                     if(!t)   this.isSelected && (this.isSelected = !1, this.destroySelection(), this.trigger("unselect", null, t))
                },
                destroySelection: function() {},
                documentMousedown: function(e) {
                        var n;
